  ...
  <head>
    ...
    <style>
      ...
      .swal2-styled.swal2-confirm {
        background-color: #3970b0 !important;
        color: white;
        border: none;
      }
      .botones {
  ...
  <body>
                ...
                <tbody>
                  <c:forEach var="ele" items="${citasLista }">
                    <tr>
                      ...
                      <td>
                        <a href="/verUna/${ele.idCita}" class="btnMas"
                          >Ver mas</a
                        >
                      </td>
                    </tr>
                ...
                <tbody>
                  <c:forEach var="ele" items="${citasListaMedico }">
                    <tr>
                      ...
                      <td>
                        <a
                          href="/cancelarUna/${ele.idCita}"
                          class="botones cancelar"
                          >Cancelar</a
                        >
    ...
    <c:if test="${infousu == 'rellenar'}">
      <script>
        Swal.fire({
          title:
            '<strong>¿Quieres rellenar tus datos de <u>perfil</u>?</strong>',
          icon: 'info',
          html:
    ...
    <script>
      ...
      const options = {
        ...
        headers: {
          'x-rapidapi-key':
            '90cad11506mshd20305fc7490e71p12fb87jsn442317af3e7f',
      ...
      axios
        ...
        .then(function (response) {
          ...
          if (response.status == 'error') {
            ...
            const titulo = document.createTextNode(
