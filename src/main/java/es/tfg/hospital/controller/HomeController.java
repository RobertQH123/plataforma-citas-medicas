...
public class HomeController {
	...
	public String acceso(HttpSession misesion) {
		if (misesion.getAttribute("dni") == null) {// comprobamos si la session esta guardada el idSessCuent se crea en
													// la linea 57
	...
	public String editarUna(Model model, @RequestParam("idCita") String idCita,
			...
			@RequestParam("direccionCentrosalud") String direccionCentrosalud,
	...
	public String pedircita(RedirectAttributes ratt, Model model, RedirectAttributes redir,
			...
			@RequestParam("sintomas") String sintomas, @RequestParam("dni") Usuario dni,
			@RequestParam("nombre") String nombre, @RequestParam("nombre_medico") String nombre_medico) {
		Cita cita = new Cita();
	...
	public String modificarInformacion(RedirectAttributes ratt, Model model, @RequestParam("peso") Integer peso,
			@RequestParam("altura") String altura, @RequestParam("edad") Integer edad,
	...
	public String modificarDiagnostico(RedirectAttributes ratt, Model model, @RequestParam("alergias") String alergias,
			@RequestParam("tratamientos") String tratamientos, @RequestParam("operaciones") String operaciones,
			@RequestParam("enfermedades") String enfermedades,
			@RequestParam("dni") String dni) {
		Diagnostico diagnostico = ddao.buscarDiagnostico(dni);
		if (diagnostico == null) {
			Diagnostico diagnosticoC = new Diagnostico(alergias, enfermedades, operaciones, tratamientos,
					udao.buscarUsuario(dni));
	...
	public String cambioContraseña(Model model, HttpSession misesion,
			@RequestParam("contraseñaActual") String contraseñaActual,
			@RequestParam("nuevaContraseña") String nuevaContraseña,
			@RequestParam("contraseñaVerificada") String contraseñaVerificada, Usuario usario) {
